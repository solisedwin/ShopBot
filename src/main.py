...
class MainClass(object):
	...
	def main(self):
		...
		parser.add_argument('-a', '--article', help = "Clothing Item Article", type = str)
		...
		supreme_bot = SupremeWeb(bot_config, item_clothing_article = item_clothing_article , item_name = item_name, item_color = item_color, item_size = item_size)
